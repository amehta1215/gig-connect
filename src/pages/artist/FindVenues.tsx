...
export default function FindVenues() {
  ...
  return <div className="space-y-6 animate-fade-in">
      ...
      {loading ? <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
          ...
          <h3 className="font-display text-2xl text-muted-foreground uppercase">NO VENUES MATCH YOUR SEARCH</h3>
              ...
              <div className="p-3">
                ...
                {(() => {
                  ...
                  return <div className="flex flex-wrap gap-1 mt-2">
                    {g.slice(0, 2).map(genre => <span key={genre} className="text-[10px] px-2 py-0.5 uppercase tracking-wider text-primary bg-gray-200">
