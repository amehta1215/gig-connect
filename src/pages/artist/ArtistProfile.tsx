...
import { ArrowLeft, Save, Image, Music, X, Upload } from 'lucide-react';
    ...
    <div className="space-y-6 animate-fade-in max-w-3xl">
      ...
      <div className="bg-card border border-border rounded-xl p-6 space-y-4">
        ...
        <div className="space-y-3">
          ...
          {featuredSamples.length < 3 && (
            <button
              onClick={() => sampleInputRef.current?.click()}
              disabled={uploadingSample}
              className="w-full p-4 border-2 border-dashed border-border rounded-lg flex items-center justify-center gap-2 hover:border-primary transition-colors cursor-pointer"
            >
