...
export default function VenueCalendar() {
  ...
  return <div className="space-y-6 animate-fade-in">
      <div className="grid md:grid-cols-2 md:grid-rows-[400px_auto] gap-6 items-start">
        ...
        <div className={cn("relative bg-card border border-border flex flex-col row-start-1 col-start-2", selectedDateBoxHeight > 400 ? "md:row-span-2" : "")} style={{ minHeight: Math.max(250, selectedDateBoxHeight) }}>
