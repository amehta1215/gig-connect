              ...
              <div className="space-y-6 mt-4">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    {pictures.map((url, index) => (
                      <div key={index} className="relative group aspect-square">
                        ...
                        <button 
                          type="button" 
                          onClick={() => removeRoomPicture(index)} 
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div className="space-y-1">
                      ...
                      <LocationAutocomplete 
                        ...
                        onChange={value => setRoomFormData({
                          ...roomFormData,
                          location: value
                        })} 
                      ...
                      {availableGenres.map(genre => (
                        <button 
                          ...
                          className={`px-3 py-1 text-xs font-display tracking-wider transition-colors ${
                            roomFormData.genres.includes(genre) 
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <Textarea 
                      id="backline_info" 
                      value={roomFormData.backline_info} 
                      onChange={e => setRoomFormData({
                        ...roomFormData,
        ...
        {listings.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {listings.map(listing => (
              <div 
                key={listing.id} 
                className="bg-background border border-border overflow-hidden hover:border-primary/50 transition-colors rounded-lg"
              >
                {/* Image */}
