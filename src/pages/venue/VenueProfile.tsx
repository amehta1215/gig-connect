...
export default function VenueProfile() {
  ...
  return <div className="space-y-6 animate-fade-in max-w-3xl mx-auto">
      ...
      <Dialog open={previewOpen} onOpenChange={setPreviewOpen}>
        <DialogContent className="!fixed !inset-0 !left-0 !top-0 !translate-x-0 !translate-y-0 !flex !h-screen !w-screen !max-h-none !max-w-none !flex-col !gap-0 !rounded-none !p-0 bg-card border-border overflow-hidden">
