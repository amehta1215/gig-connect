...
export default function VenueApplications() {
  ...
  const ApplicationCard = ({ application }: { application: Application }) => {
    ...
    return (
      <div className={`bg-card border p-4 transition-colors ${
        !application.is_read ? 'border-primary/50' : 'border-border hover:border-primary/30'
      }`}>
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex flex-wrap gap-2 items-center">
        ...
        <button
          ...
          className={`px-3 py-2 text-xs font-display tracking-wider transition-colors ${
            filterUnread
