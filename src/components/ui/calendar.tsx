  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_today: "!bg-transparent border-2 !border-accent !text-accent rounded-full hover:!bg-transparent hover:!text-accent focus:!bg-transparent focus:!text-accent",
        day_outside:
